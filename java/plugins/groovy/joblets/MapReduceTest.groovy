...
class MapReduceTest implements SimpleJoblet {
	...
	public SimpleJobletResult execute(Joblet joblet, DGridClient gridClient)
		...
		if (nums.length <= 10) {
			...
			String leftContents = getString(leftArray);
			String rightContents = getString(rightArray);
			...
			System.err.println("Groovy submitting task for f/j");
